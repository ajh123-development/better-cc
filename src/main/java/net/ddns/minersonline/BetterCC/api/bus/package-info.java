 ...
 * <p>
 * A bus must always be managed by a {@link net.ddns.minersonline.BetterCC.api.bus.DeviceBusController}.
 * If there is no controller, there is no (connected) bus.
 * <p>
 * When a controller performs a scan, it collects a list of connected
 * {@link net.ddns.minersonline.BetterCC.api.bus.DeviceBusElement}s thus defining a
 * {@link net.ddns.minersonline.BetterCC.api.bus.DeviceBus}.
 ...
 * <p>
 * {@link net.ddns.minersonline.BetterCC.api.bus.DeviceBusElement}s are responsible for
 ...
 * <p>
 * After a scan {@link net.ddns.minersonline.BetterCC.api.bus.DeviceBusController}s then
 ...
 * types of devices are defined in this API, {@link net.ddns.minersonline.BetterCC.api.bus.device.rpc.RPCDevice}
 * and {@link net.ddns.minersonline.BetterCC.api.bus.device.vm.VMDevice}.
 * <ul>
 * <li>
...
package net.ddns.minersonline.BetterCC.api.bus;
