...
import net.ddns.minersonline.BetterCC.common.block.EnergyConsumingBlock;
...
import static net.ddns.minersonline.BetterCC.common.util.TextFormatUtils.withFormat;
...
public final class TooltipUtils {
    ...
    public static void addBlockEntityInventoryInformation(final ItemStack stack, final List<Component> tooltip) {
        addInventoryInformation(NBTUtils.getChildTag(stack.getTag(), Constants.BLOCK_ENTITY_TAG_NAME_IN_ITEM, Constants.ITEMS_TAG_NAME), tooltip);
    }

    public static void addEntityInventoryInformation(final ItemStack stack, final List<Component> tooltip) {
        addInventoryInformation(NBTUtils.getChildTag(stack.getTag(), Constants.MOD_TAG_NAME, Constants.ITEMS_TAG_NAME), tooltip);
    }
