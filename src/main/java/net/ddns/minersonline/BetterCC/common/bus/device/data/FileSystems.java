...
import net.ddns.minersonline.BetterCC.common.vm.fs.LayeredFileSystem;
            ...
            try {
                ...
                switch (type) {
                    ...
                    case "block" -> {
                        ...
                        LOGGER.info("  Adding block device [{}] with id [{}] and a size of [{}].", name, location, TextFormatUtils.formatSize(data.getBlockDevice().getCapacity()));
