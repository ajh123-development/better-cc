...
import net.ddns.minersonline.BetterCC.client.audio.LoopingSoundManager;
import net.ddns.minersonline.BetterCC.common.Config;
import net.ddns.minersonline.BetterCC.common.block.ComputerBlock;
import net.ddns.minersonline.BetterCC.common.bus.AbstractBlockDeviceBusElement;
import net.ddns.minersonline.BetterCC.common.bus.BlockDeviceBusController;
...
import net.ddns.minersonline.BetterCC.common.container.ComputerInventoryContainer;
import net.ddns.minersonline.BetterCC.common.container.ComputerTerminalContainer;
...
import net.ddns.minersonline.BetterCC.common.network.message.ComputerBootErrorMessage;
import net.ddns.minersonline.BetterCC.common.network.message.ComputerBusStateMessage;
import net.ddns.minersonline.BetterCC.common.network.message.ComputerRunStateMessage;
import net.ddns.minersonline.BetterCC.common.network.message.ComputerTerminalOutputMessage;
import net.ddns.minersonline.BetterCC.common.serialization.NBTSerialization;
import net.ddns.minersonline.BetterCC.common.util.*;
...
public final class ComputerBlockEntity extends ModBlockEntity implements TerminalUserProvider, TickableBlockEntity {
    ...
    public void exportToItemStack(final ItemStack stack) {
        deviceItems.saveItems(NBTUtils.getOrCreateChildTag(stack.getOrCreateTag(), Constants.BLOCK_ENTITY_TAG_NAME_IN_ITEM, Constants.ITEMS_TAG_NAME));
    }
