...
public final class PredictionMerger {
    public static void mergePrediction(final SliceHeader sh, final int refIdxL0, final int refIdxL1, final H264Const.PartPred predType, final int comp,
        ...
        if (sh.sliceType == SliceType.P) {
            ...
            if (!pps.weightedPredFlag || sh.pps.weightedBipredIdc == 0
                || (sh.pps.weightedBipredIdc == 2 && predType != H264Const.PartPred.Bi)) {
    ...
    private static void mergeAvg(final byte[] blk0, final byte[] blk1, final int stride, final H264Const.PartPred p0, final int off, final int blkW, final int blkH,
								 final byte[] out) {
    ...
    private static void mergeWeight(final byte[] blk0, final byte[] blk1, final int stride, final H264Const.PartPred partPred, final int off, final int blkW,
