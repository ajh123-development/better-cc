...
import net.ddns.minersonline.BetterCC.jcodec.codecs.h264.decode.BlockInterpolator;
...
public final class MBWriterP16x16 {
    ...
    private static void writeAC(final EncodingContext ctx, final int mbX,
        ...
        for (int bIndx = 0; bIndx < ac.length; bIndx++) {
            ...
            final int blkOffLeft = H264Const.MB_DISP_OFF_LEFT[bIndx];
            final int blkOffTop = H264Const.MB_DISP_OFF_TOP[bIndx];
