...
public final class SliceDecoder {
    ...
    private void decodeMBlockP(final MBlock mBlock, final Picture mb, final Frame[][] references) {
        if (MBType.P_16x16 == mBlock.curMbType) {
            decoderInter.decode16x16(mBlock, mb, references, H264Const.PartPred.L0);
        } else if (MBType.P_16x8 == mBlock.curMbType) {
            decoderInter.decode16x8(mBlock, mb, references, H264Const.PartPred.L0, H264Const.PartPred.L0);
        } else if (MBType.P_8x16 == mBlock.curMbType) {
            decoderInter.decode8x16(mBlock, mb, references, H264Const.PartPred.L0, H264Const.PartPred.L0);
        } else if (MBType.P_8x8 == mBlock.curMbType) {
            decoderInter8x8.decode(mBlock, references, mb, SliceType.P);
