...
package net.ddns.minersonline.BetterCC.client.gui.widget;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.vertex.PoseStack;
import net.ddns.minersonline.BetterCC.common.util.TooltipUtils;
import net.ddns.minersonline.BetterCC.common.util.TextFormatUtils;
...
public abstract class ImageButton extends AbstractButton {
    ...
    public ImageButton withTooltip(final Component... components) {
        ...
        for (int i = 1; i < tooltip.size(); i++) {
            ...
            tooltip.set(i, TextFormatUtils.withFormat(component, ChatFormatting.GRAY));
        }
        return this;
    }
