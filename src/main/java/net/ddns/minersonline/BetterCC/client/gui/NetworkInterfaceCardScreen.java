...
import net.ddns.minersonline.BetterCC.client.gui.widget.Texture;
import net.ddns.minersonline.BetterCC.client.renderer.ModRenderType;
import net.ddns.minersonline.BetterCC.common.item.Items;
import net.ddns.minersonline.BetterCC.common.item.NetworkInterfaceCardItem;
import net.ddns.minersonline.BetterCC.common.network.Network;
import net.ddns.minersonline.BetterCC.common.network.message.NetworkInterfaceCardConfigurationMessage;
...
import static net.ddns.minersonline.BetterCC.common.util.TranslationUtils.key;
import static net.ddns.minersonline.BetterCC.common.util.TranslationUtils.text;
