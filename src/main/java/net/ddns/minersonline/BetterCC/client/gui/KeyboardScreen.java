...
import net.ddns.minersonline.BetterCC.common.network.message.KeyboardInputMessage;
...
public final class KeyboardScreen extends Screen {
    ...
    private static final TranslatableComponent CLOSE_INFO = new TranslatableComponent("gui.better_cc.keyboard.close_info");
