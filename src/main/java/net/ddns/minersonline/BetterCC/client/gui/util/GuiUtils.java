...
package net.ddns.minersonline.BetterCC.client.gui.util;
...
import net.ddns.minersonline.BetterCC.client.gui.widget.Sprite;
import net.ddns.minersonline.BetterCC.common.container.DeviceTypeSlotItemHandler;
