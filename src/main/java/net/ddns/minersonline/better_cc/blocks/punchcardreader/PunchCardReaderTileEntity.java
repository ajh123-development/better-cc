...
public class PunchCardReaderTileEntity extends LockableTileEntity implements ISidedInventory, ITickableTileEntity {
    ...
    public void tick() {
        if (this.level != null && !this.level.isClientSide) {
            ...
            if (block instanceof PunchCardReaderBlock) {
                ((PunchCardReaderBlock) block).tick(this.level, blockstate);
            }
        }
    ...
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return new PunchCardReaderContainer(id, playerInventory, this, this.fields);
    }
